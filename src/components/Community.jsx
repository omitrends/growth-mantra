  ...
  const handleCreatePost = (e) => {
    ...
    if (newPostTitle.trim() && newPostContent.trim()) {
      const newPost = {
        ...
        downvotes: 0,
        saved: false,
        tags: newPostTitle.toLowerCase().split(' ').filter(word => word.length > 3).slice(0, 3)
      };
      ...
      // Add notification
      setNotifications([
        { id: Date.now(), message: "Your post has been published successfully!", type: "success" },
        ...notifications
      ]);
